...
# -*- coding: utf-8 -*-
#
# CentreStack File Server Agent documentation build configuration file, created by
# sphinx-quickstart on Mon Oct 12 08:59:34 2015.
#
...
htmlhelp_basename = 'CentreStackFileServerAgentdoc'
